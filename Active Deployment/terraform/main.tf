...
resource "grid_network" "net1" {
    nodes = [13, 291, 297, 298, 299, 300, 301]
...
output "node4_vm1_ip" {
value = grid_deployment.D4.vms[0].ip
}
output "node5_vm1_ip" {
value = grid_deployment.D5.vms[0].ip
}
output "node6_vm1_ip" {
value = grid_deployment.D6.vms[0].ip
}
output "node7_vm1_ip" {
value = grid_deployment.D7.vms[0].ip
}
